    ...
    return (
        <section>
            ...
            <div className="offer-box">
                ...
                />
                <Offerbox
                    icon={<img className={"mb-5"} src={money} alt={"fastFood"}/>}
